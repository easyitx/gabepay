...
interface SecurityCardIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

export const SecurityCardIcon: React.FC<SecurityCardIconProps> = ({
  ...props
}) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M22 9.42001V14.97C21.98 17.19 21.37 17.74 19.06 17.74H11.74C9.39001 17.74 8.8 17.15 8.8 14.84V9.41C8.8 7.31 9.28 6.63999 11.13 6.51999C11.32 6.51999 11.52 6.51001 11.74 6.51001H19.06C21.41 6.52001 22 7.10001 22 9.42001Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
